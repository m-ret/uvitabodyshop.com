# HEARTBEAT.md -- Engineer 2 Heartbeat Checklist
...
- Read the research document on UVI-8 for design direction specs and competitive intelligence.
- Do the work. Write clean, production-quality code.

## 4. Engineering Standards

- Use the skills available in `~/.claude/skills/` -- especially `gstack` for browser QA.
